...
Our tutorials should be procedural, which walk the reader through accomplishing a task or understanding a complex concept step-by-step. The structure for a procedural tutorial should orientate itself on the following structure:
...
- …
- **Conclusion and further study** (Level 2 heading) 
  - What was learned
  - What can the reader do next, where can they deepen their aquired knowledge

:::note todo
Link and explain the tutorial template
:::
