...
You can of course write your tutorial without sticking to this guide, just open an editor and begin writing markdown. However there
might come a time when you want to see it with the polkadot.study UI, with interactive elements or just test it - then this is the 
right time to follow along here.
