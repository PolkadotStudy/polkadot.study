...
export default function Quiz({
  ...
  const isAnswerCorrect = () => {
    ...
    let res = checkedState.reduce((prev, curr, idx) => {
      let correct = false;
      correct = (correctAnswerIdxArray as Array<number>).includes(idx)
        ? curr
        : curr == false;
      return prev && correct;
    }, true);
  ...
  const solutionClassName = cn(styles.feedback, {
