...
security and privacy of their users. With web3 that can now be done without
username + password authentication but instead using a wallet and a browser
extension.
...
[https://polkadot-tokengated-website.vercel.app/](https://polkadot-tokengated-website.vercel.app/)
