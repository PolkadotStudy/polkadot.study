...
To create a React project with Chakra UI library, you can follow these steps:
...
## Create GUI components for wallet project.


In this tutorial we will build 2 basic GUI components for a wallet using the Chakra UI and Polkadot-js API, in this first step we will create the graphical interface using the Chakra UI library and in the next section we will add functionality with the Polkadot-js API. these components will be:
...
### 1. ``Newaccounts:`` Create a new seed phrase and get public and private keys.

The first UI component we'll build is to create a seed phrase and get the associated public and private keys.
     ...
     return (
        <VStack>
            ...
            <HStack>
              ...
              <Button colorScheme='red' className='center' borderRadius="20px" > 
                 Add new account 
              </Button>
          </HStack>
        </VStack>   
...
---
### 2. ``Addaccounts``: Add an existing seed phrase and get public and private keys.
...
Finally with the graphic components we can build a basic functional wallet as will be shown in the following sections.
