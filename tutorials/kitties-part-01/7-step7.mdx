...
Lets try a few snippets to understand how the query is retrieving the balances. But first is necessary to check how the 
storage we are querying looks like:

This is the [accounts storage](https://github.com/paritytech/substrate/blob/948fbd2fd1233dc26dbb9f9bbc1d2cca2c03945d/frame/system/src/lib.rs#L549):
...
account info. The [account info](https://github.com/paritytech/substrate/blob/948fbd2fd1233dc26dbb9f9bbc1d2cca2c03945d/frame/system/src/lib.rs#L732C1-L749C2) is defined as follows:
...
file in the kitties node you will see it is defined as follows:
...
```
So its form is defined in the [balances pallet](https://github.com/paritytech/substrate/blob/948fbd2fd1233dc26dbb9f9bbc1d2cca2c03945d/frame/balances/src/types.rs#L93) as:
